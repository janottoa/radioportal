...
// URL til metadata
const metadataUrl = 'URL_TIL_METADATA'; // Sett denne til URL-en du bruker for metadata

// WebSocket til dashboard
let socket = new WebSocket("ws://localhost:PORT"); // Endre PORT til riktig port for dashboard-tilkoblingen
