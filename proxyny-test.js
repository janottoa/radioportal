...
function startFfmpeg(ws, streamUrl) {
    logError(`Starter FFmpeg-prosess for URL: ${streamUrl}`);
...
wss.on('connection', (ws) => {
    ...
    ws.on('message', (streamUrl) => {
        ...
        // Start opp den nye FFmpeg prosessen
    ...
    ws.on('close', () => {
        ...
        // Stopp ffmpeg hvis den er aktiv
        if (currentFfmpegProcess) {
            currentFfmpegProcess.kill(); // Stenger ffmpeg prosessen
        }
