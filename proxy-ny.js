        ...
        ffmpeg.stderr.on('data', async (data) => {
            ...
            if (titleMatch) {
                ...
                const metadata = {
                    ...
                    title: title,
                    artist: artist,
                    album: processedMetadata.album || (albumData && albumData.album_name) || null,
                    trackSpotifyId: albumData ? albumData.track_spotify_id : null,
                    popularity: albumData ? albumData.popularity : null,
                };
